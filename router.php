...
function get_authenticated_user() {
    ...
    $email = "ignacio.estrada@videray.com";
    $api_key = "nlM8pJh7J1EyahioqbU2DbHilSwKKePF";

    // Create a Basic Authentication string with the email and API key
    $credentials = base64_encode("$email:$api_key");
    $basic_auth = "Basic $credentials";

    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_HTTPHEADER, ["Authorization: $basic_auth"]);
